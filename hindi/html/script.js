...
function showNotes() {
  ...
  notesObj.forEach(function (element, index) {
    html += `
        ...
        <div class="card">
            ...
            <p>${element.title}</p>
            <button onClick="deleteNote(this.id)" id="${index}" class="deleteBtn">प्रेषण उत्पाद</button>
        </div>
        </div>`;
  });
  ...
  if (notesObj.length == 0) {
    insertNotes.innerHTML = `दिखाने के लिए कुछ नहीं! नया आदेश जोड़ने के लिए कृपया "अनुसूची आदेश" बटन पर क्लिक करें।`;
